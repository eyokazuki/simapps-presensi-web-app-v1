      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            <!-- <img src="<?= base_url(); ?>assets/img/logo_kecil_1.png" alt="logo" class="logo-brand-nav"> -->
          </div>
        </form>
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, <?= $ses["s_nama"]; ?></div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item has-icon text-info" data-toggle="modal" data-target="#logoutModal">
