...
<!-- <script src="<?php echo base_url(); ?>assets/modules/socket.io/socket.io.min.js"></script> -->
...
<script>
  ...
  $(".<?php echo $breadcumb_menu; ?>").addClass("active");
  $(".<?php echo $breadcumb_parent; ?>").addClass("active");
  $(".collapse_menu.<?php echo $breadcumb_parent; ?>").addClass("show");
