...
<body id="pdfContainer" class="bg-white">
    <div class="row">
        <div class="col-12">
            <h5 class="text-center">Grafik Kehadiran<br /><small>(<?= "$month $year" ?>)</small></h5>
            <div id="grafikKehadiran" style="width: 297mm;"></div>
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="col-12">
            <h5 class="text-center">Grafik Kesehatan<br /><small>(<?= "$month $year" ?>)</small></h5>
            <div id="grafikKesehatan" style="width: 297mm;"></div>
        </div>
    </div>
    <br/>
    <div class="row">
        <div class="col-12">
            <h5 class="text-center">Grafik Absensi<br /><small>(<?= "$month $year" ?>)</small></h5>
            <div id="grafikAbsen" style="width: 297mm;"></div>
        </div>
    </div>
</body>
<script src="<?= base_url('assets/vendor/libs/apex-charts/apexcharts.js') ?>"></script>
<script>
    const colorGrafik = ['#2a9d8f', '#fb8500', '#3a86ff', "#e63946", "#8338ec", "#264653", "#bb9457"];
