...
class Report extends CI_Controller
{
    ...
    public function send_report()
    {
        ...
        $message            = 'Dengan hormat, <br>Berikut disampaikan Laporan Absensi Harian Pekerja JOB Simenggaris per tanggal ' . $tanggal_indo . ' Pk.10.00 WIB / Pk.11.00 WITA.<br><br>Terima kasih.';
    ...
    public function send_report2()
    {
        ...
        $tanggal_indo = $this->globalfungsi->tgl_indonesia($tanggal);
        $email_subject      = 'Laporan Absensi Pekerja [' . $tanggal_indo . ']';
        $message            = 'Dengan hormat, <br>Berikut disampaikan Laporan Absensi Harian Pekerja JOB Simenggaris per tanggal ' . $tanggal_indo . '.<br><br>Terima Kasih.';
        $email_pengirim     = 'job.simenggaris@job-simenggaris.com';
        $this->email->from($email_pengirim, 'Job Simenggaris');
        $this->email->subject($email_subject);
        $this->email->message($message);
    ...
    public function send_email2()
    {
        ...
        $listPenerima = $this->dbmodels->get_penerima()->result();
        $email_subject      = 'Laporan Absensi Pekerja [' . $tanggal_indo . ']';
        $message            = 'Dengan hormat, <br>Berikut disampaikan Laporan Absensi Harian Pekerja JOB Simenggaris per tanggal ' . $tanggal_indo . '.<br><br>' . base_url('report?' . $tanggal_enkripsi . '') . '';
