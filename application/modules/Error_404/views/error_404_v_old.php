            ...
            <div class="container mt-5">
                <div class="page-error">
                    <div class="page-inner">
                        ...
                        <a href="<?= base_url(); ?>dashboard" class="btn btn-warning btn-lg mt-5" style="color:white">
                            Back to Home
                        </a>
                    </div>
                </div>
                <div class="simple-footer mt-5">
                    Copyright &copy; 2023 Kabupaten Layak Anak Kabupaten Gresik
                </div>
            </div>
        </section>
    </div>
